...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    hotel_options_title: "Options d'Hébergement",
    hotel_select_label: "Choisir votre hôtel",
    hotel_selected_btn: "✓ Sélectionné",
    hotel_select_btn: "Choisir cet hôtel",
    hotel_departure_label: "Date de départ",
    hotel_per_adult: "/ adulte",
    hotel_per_child: "/ enfant",
    hotel_child_ordinal: "Enfant",
    hotel_see_reviews: "Voir les avis",
    hotel_accommodation: "Hébergement",
    hotel_starting_from: "à partir de",
    ...
    footer_address_tlemcen: "Résidence les merinides bt C N 15, Imama, Tlemcen",
    footer_address_oran: "Résidence SOFIA, rue DUBAI, haï Akid Lotfi, Oran",
    footer_hours: "Samedi - Jeudi : 9:00 - 17:00 (Fermé le Vendredi)",
  ...
  ar: {
    ...
    hotel_options_title: "خيارات الإقامة",
    hotel_select_label: "اختر فندقك",
    hotel_selected_btn: "✓ محدد",
    hotel_select_btn: "اختر هذا الفندق",
    hotel_departure_label: "تاريخ المغادرة",
    hotel_per_adult: "/ بالغ",
    hotel_per_child: "/ طفل",
    hotel_child_ordinal: "طفل",
    hotel_see_reviews: "عرض التقييمات",
    hotel_accommodation: "الإقامة",
    hotel_starting_from: "ابتداءً من",
    ...
    footer_address_tlemcen: "إقامة المريندس، بت ج ن 15، الإمامة، تلمسان",
    footer_address_oran: "إقامة صوفيا، شارع دبي، حي عقيد لطفي، وهران",
    footer_hours: "السبت - الخميس: 9:00 - 17:00 (مغلق يوم الجمعة)",
