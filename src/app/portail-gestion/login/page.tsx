    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-10">
          <Link 
            href="/" 
            className="inline-flex flex-col items-center gap-3.5 mb-6 group cursor-pointer"
            title="Retour à l'accueil"
          >
            <LogoSymbol className="h-16 w-auto" fillClassName="fill-blue-500" />
            <LogoText className="h-9 w-auto" fillClassName="fill-white" />
          </Link>
